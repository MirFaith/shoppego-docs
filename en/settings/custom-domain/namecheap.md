...
![](../../../.gitbook/assets/v4pcStpzdmFuocIzM4vr.png)
...
![](../../../.gitbook/assets/2VxjDSk9JznR9qY9u0Pm.png)

5\. In the **HOST RECORDS** column you can click on the **ADD NEW RECORD** button

![](../../../.gitbook/assets/mml6F6Vj72TKguwTKFqF.png)
...
{% hint style="warning" %}
**Attention**: Make sure your setup only has **CNAME records**, other records such as *URL Redirect records* or A records can be <mark style="color:red;">**removed**</mark> from the setup.
{% endhint %}
